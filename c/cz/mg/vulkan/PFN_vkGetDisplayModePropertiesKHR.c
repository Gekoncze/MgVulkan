...
void Java_cz_mg_vulkan_vk_PFNvkGetDisplayModePropertiesKHR_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong display, jlong pPropertyCount, jlong pProperties, jlong rval){
    (void)env;
    (void)jc;
