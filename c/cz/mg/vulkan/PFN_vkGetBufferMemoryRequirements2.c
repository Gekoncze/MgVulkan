...
void Java_cz_mg_vulkan_vk_PFNvkGetBufferMemoryRequirements2_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pInfo, jlong pMemoryRequirements){
    (void)env;
    (void)jc;
