...
void Java_cz_mg_vulkan_vk_PFNvkAcquireNextImage2KHR_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pAcquireInfo, jlong pImageIndex, jlong rval){
    (void)env;
    (void)jc;
