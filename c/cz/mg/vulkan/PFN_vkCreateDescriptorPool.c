...
void Java_cz_mg_vulkan_vk_PFNvkCreateDescriptorPool_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pDescriptorPool, jlong rval){
    (void)env;
    (void)jc;
