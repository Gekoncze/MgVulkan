...
void Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceSurfaceSupportKHR_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong queueFamilyIndex, jlong surface, jlong pSupported, jlong rval){
    (void)env;
    (void)jc;
