...
void Java_cz_mg_vulkan_vk_PFNvkCmdSetViewportWScalingNV_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong firstViewport, jlong viewportCount, jlong pViewportWScalings){
    (void)env;
    (void)jc;
