...
void Java_cz_mg_vulkan_vk_PFNvkCreateIndirectCommandsLayoutNVX_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pIndirectCommandsLayout, jlong rval){
    (void)env;
    (void)jc;
