...
void Java_cz_mg_vulkan_vk_PFNvkGetPhysicalDeviceFormatProperties2KHR_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong format, jlong pFormatProperties){
    (void)env;
    (void)jc;
