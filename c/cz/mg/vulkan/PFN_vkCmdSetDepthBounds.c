...
void Java_cz_mg_vulkan_vk_PFNvkCmdSetDepthBounds_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong minDepthBounds, jlong maxDepthBounds){
    (void)env;
    (void)jc;
