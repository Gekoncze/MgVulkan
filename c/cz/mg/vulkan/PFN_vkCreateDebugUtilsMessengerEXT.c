...
void Java_cz_mg_vulkan_PFNvkCreateDebugUtilsMessengerEXT_call(JNIEnv* env, jclass jc, jlong address, jlong instance, jlong pCreateInfo, jlong pAllocator, jlong pMessenger, jlong rval){
    (void)env;
    (void)jc;
