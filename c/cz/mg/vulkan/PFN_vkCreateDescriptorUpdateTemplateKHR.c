...
void Java_cz_mg_vulkan_vk_PFNvkCreateDescriptorUpdateTemplateKHR_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pDescriptorUpdateTemplate, jlong rval){
    (void)env;
    (void)jc;
