...
void Java_cz_mg_vulkan_PFNvkCreateSemaphore_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pSemaphore, jlong rval){
    (void)env;
    (void)jc;
