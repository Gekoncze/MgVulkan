...
void Java_cz_mg_vulkan_vk_PFNvkGetPhysicalDeviceMemoryProperties2KHR_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong pMemoryProperties){
    (void)env;
    (void)jc;
