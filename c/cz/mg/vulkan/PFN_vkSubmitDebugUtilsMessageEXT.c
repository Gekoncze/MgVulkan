...
void Java_cz_mg_vulkan_vk_PFNvkSubmitDebugUtilsMessageEXT_call(JNIEnv* env, jclass jc, jlong address, jlong instance, jlong messageSeverity, jlong messageTypes, jlong pCallbackData){
    (void)env;
    (void)jc;
