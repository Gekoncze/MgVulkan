...
void Java_cz_mg_vulkan_vk_PFNvkGetPhysicalDeviceQueueFamilyProperties2_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong pQueueFamilyPropertyCount, jlong pQueueFamilyProperties){
    (void)env;
    (void)jc;
