...
void Java_cz_mg_vulkan_vk_PFNvkCreatePipelineLayout_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pPipelineLayout, jlong rval){
    (void)env;
    (void)jc;
