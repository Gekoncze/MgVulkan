...
void Java_cz_mg_vulkan_vk_PFNvkEnumerateInstanceExtensionProperties_call(JNIEnv* env, jclass jc, jlong address, jlong pLayerName, jlong pPropertyCount, jlong pProperties, jlong rval){
    (void)env;
    (void)jc;
