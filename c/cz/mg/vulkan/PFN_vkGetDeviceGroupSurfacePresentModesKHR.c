...
void Java_cz_mg_vulkan_vk_PFNvkGetDeviceGroupSurfacePresentModesKHR_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong surface, jlong pModes, jlong rval){
    (void)env;
    (void)jc;
