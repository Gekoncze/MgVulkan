...
void Java_cz_mg_vulkan_vk_PFNvkGetPhysicalDeviceSurfaceCapabilitiesKHR_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong surface, jlong pSurfaceCapabilities, jlong rval){
    (void)env;
    (void)jc;
