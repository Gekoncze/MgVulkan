...
void Java_cz_mg_vulkan_vk_PFNvkFreeCommandBuffers_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong commandPool, jlong commandBufferCount, jlong pCommandBuffers){
    (void)env;
    (void)jc;
