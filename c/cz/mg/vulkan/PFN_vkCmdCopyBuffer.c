...
void Java_cz_mg_vulkan_vk_PFNvkCmdCopyBuffer_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong srcBuffer, jlong dstBuffer, jlong regionCount, jlong pRegions){
    (void)env;
    (void)jc;
