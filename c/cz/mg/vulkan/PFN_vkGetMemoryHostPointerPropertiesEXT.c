...
void Java_cz_mg_vulkan_PFNvkGetMemoryHostPointerPropertiesEXT_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong handleType, jlong pHostPointer, jlong pMemoryHostPointerProperties, jlong rval){
    (void)env;
    (void)jc;
