...
void Java_cz_mg_vulkan_vk_PFNvkGetPhysicalDeviceExternalFencePropertiesKHR_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong pExternalFenceInfo, jlong pExternalFenceProperties){
    (void)env;
    (void)jc;
