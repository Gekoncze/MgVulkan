...
jlong Java_cz_mg_vulkan_VkInt64_getValue(JNIEnv* env, jclass jc, jlong address)
{
    (void)env;
    (void)jc;
    jlong value;
...
void Java_cz_mg_vulkan_VkInt64_setValue(JNIEnv* env, jclass jc, jlong address, jlong value)
{
    (void)env;
    (void)jc;
