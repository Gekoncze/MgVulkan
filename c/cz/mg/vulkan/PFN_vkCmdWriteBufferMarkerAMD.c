...
void Java_cz_mg_vulkan_vk_PFNvkCmdWriteBufferMarkerAMD_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong pipelineStage, jlong dstBuffer, jlong dstOffset, jlong marker){
    (void)env;
    (void)jc;
