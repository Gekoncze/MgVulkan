...
void Java_cz_mg_vulkan_vk_PFNvkCreateSamplerYcbcrConversionKHR_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pYcbcrConversion, jlong rval){
    (void)env;
    (void)jc;
