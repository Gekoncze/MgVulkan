...
void Java_cz_mg_vulkan_vk_PFNvkDestroySamplerYcbcrConversionKHR_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong ycbcrConversion, jlong pAllocator){
    (void)env;
    (void)jc;
