...
void Java_cz_mg_vulkan_vk_PFNvkWaitForFences_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong fenceCount, jlong pFences, jlong waitAll, jlong timeout, jlong rval){
    (void)env;
    (void)jc;
