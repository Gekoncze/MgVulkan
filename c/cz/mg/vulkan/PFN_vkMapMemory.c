...
void Java_cz_mg_vulkan_PFNvkMapMemory_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong memory, jlong offset, jlong size, jlong flags, jlong ppData, jlong rval){
    (void)env;
    (void)jc;
