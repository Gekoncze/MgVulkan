...
void Java_cz_mg_vulkan_vk_PFNvkCmdDrawIndirect_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong buffer, jlong offset, jlong drawCount, jlong stride){
    (void)env;
    (void)jc;
