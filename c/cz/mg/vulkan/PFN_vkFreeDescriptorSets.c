...
void Java_cz_mg_vulkan_vk_PFNvkFreeDescriptorSets_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong descriptorPool, jlong descriptorSetCount, jlong pDescriptorSets, jlong rval){
    (void)env;
    (void)jc;
