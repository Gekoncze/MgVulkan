...
void Java_cz_mg_vulkan_vk_PFNvkCreateDebugReportCallbackEXT_call(JNIEnv* env, jclass jc, jlong address, jlong instance, jlong pCreateInfo, jlong pAllocator, jlong pCallback, jlong rval){
    (void)env;
    (void)jc;
