...
void Java_cz_mg_vulkan_vk_PFNvkDestroyIndirectCommandsLayoutNVX_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong indirectCommandsLayout, jlong pAllocator){
    (void)env;
    (void)jc;
