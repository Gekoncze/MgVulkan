...
void Java_cz_mg_vulkan_vk_PFNvkCreateDisplayPlaneSurfaceKHR_call(JNIEnv* env, jclass jc, jlong address, jlong instance, jlong pCreateInfo, jlong pAllocator, jlong pSurface, jlong rval){
    (void)env;
    (void)jc;
