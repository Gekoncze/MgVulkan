...
void Java_cz_mg_vulkan_vk_PFNvkBindBufferMemory2KHR_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong bindInfoCount, jlong pBindInfos, jlong rval){
    (void)env;
    (void)jc;
