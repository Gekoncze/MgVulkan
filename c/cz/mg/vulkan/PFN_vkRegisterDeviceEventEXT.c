...
void Java_cz_mg_vulkan_vk_PFNvkRegisterDeviceEventEXT_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pDeviceEventInfo, jlong pAllocator, jlong pFence, jlong rval){
    (void)env;
    (void)jc;
