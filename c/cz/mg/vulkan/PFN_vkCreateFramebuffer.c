...
void Java_cz_mg_vulkan_PFNvkCreateFramebuffer_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pFramebuffer, jlong rval){
    (void)env;
    (void)jc;
