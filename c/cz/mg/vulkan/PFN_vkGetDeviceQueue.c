...
void Java_cz_mg_vulkan_vk_PFNvkGetDeviceQueue_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong queueFamilyIndex, jlong queueIndex, jlong pQueue){
    (void)env;
    (void)jc;
