...
void Java_cz_mg_vulkan_vk_PFNvkGetImageSparseMemoryRequirements2KHR_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pInfo, jlong pSparseMemoryRequirementCount, jlong pSparseMemoryRequirements){
    (void)env;
    (void)jc;
