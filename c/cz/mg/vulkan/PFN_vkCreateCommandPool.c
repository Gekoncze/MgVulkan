...
void Java_cz_mg_vulkan_PFNvkCreateCommandPool_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pCommandPool, jlong rval){
    (void)env;
    (void)jc;
