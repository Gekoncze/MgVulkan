...
void Java_cz_mg_vulkan_vk_PFNvkGetPastPresentationTimingGOOGLE_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong swapchain, jlong pPresentationTimingCount, jlong pPresentationTimings, jlong rval){
    (void)env;
    (void)jc;
