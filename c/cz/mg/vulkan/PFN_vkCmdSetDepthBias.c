...
void Java_cz_mg_vulkan_vk_PFNvkCmdSetDepthBias_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong depthBiasConstantFactor, jlong depthBiasClamp, jlong depthBiasSlopeFactor){
    (void)env;
    (void)jc;
