...
void Java_cz_mg_vulkan_PFNvkGetPhysicalDevicePresentRectanglesKHR_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong surface, jlong pRectCount, jlong pRects, jlong rval){
    (void)env;
    (void)jc;
