...
void Java_cz_mg_vulkan_PFNvkCmdClearDepthStencilImage_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong image, jlong imageLayout, jlong pDepthStencil, jlong rangeCount, jlong pRanges){
    (void)env;
    (void)jc;
