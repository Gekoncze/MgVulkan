...
void Java_cz_mg_vulkan_vk_PFNvkGetSwapchainCounterEXT_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong swapchain, jlong counter, jlong pCounterValue, jlong rval){
    (void)env;
    (void)jc;
