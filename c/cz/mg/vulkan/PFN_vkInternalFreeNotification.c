...
void Java_cz_mg_vulkan_vk_PFNvkInternalFreeNotification_call(JNIEnv* env, jclass jc, jlong address, jlong pUserData, jlong size, jlong allocationType, jlong allocationScope){
    (void)env;
    (void)jc;
