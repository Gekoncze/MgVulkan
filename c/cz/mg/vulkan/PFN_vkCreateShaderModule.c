...
void Java_cz_mg_vulkan_vk_PFNvkCreateShaderModule_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pShaderModule, jlong rval){
    (void)env;
    (void)jc;
