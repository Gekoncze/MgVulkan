...
void Java_cz_mg_vulkan_vk_PFNvkCreateQueryPool_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pQueryPool, jlong rval){
    (void)env;
    (void)jc;
