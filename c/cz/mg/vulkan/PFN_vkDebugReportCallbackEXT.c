...
void Java_cz_mg_vulkan_vk_PFNvkDebugReportCallbackEXT_call(JNIEnv* env, jclass jc, jlong address, jlong flags, jlong objectType, jlong object, jlong location, jlong messageCode, jlong pLayerPrefix, jlong pMessage, jlong pUserData, jlong rval){
    (void)env;
    (void)jc;
