...
jlong Java_cz_mg_vulkan_vk_VkViewportSwizzleNV_sizeof(JNIEnv* env, jclass jc)
{
    (void)env;
    (void)jc;
...
jlong Java_cz_mg_vulkan_vk_VkViewportSwizzleNV_getX(JNIEnv* env, jclass jc, jlong address)
{
    (void)env;
    (void)jc;
