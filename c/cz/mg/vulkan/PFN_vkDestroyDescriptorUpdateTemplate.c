...
void Java_cz_mg_vulkan_vk_PFNvkDestroyDescriptorUpdateTemplate_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong descriptorUpdateTemplate, jlong pAllocator){
    (void)env;
    (void)jc;
