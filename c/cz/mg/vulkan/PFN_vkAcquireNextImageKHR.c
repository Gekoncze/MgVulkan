...
void Java_cz_mg_vulkan_vk_PFNvkAcquireNextImageKHR_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong swapchain, jlong timeout, jlong semaphore, jlong fence, jlong pImageIndex, jlong rval){
    (void)env;
    (void)jc;
