...
void Java_cz_mg_vulkan_vk_PFNvkRegisterDisplayEventEXT_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong display, jlong pDisplayEventInfo, jlong pAllocator, jlong pFence, jlong rval){
    (void)env;
    (void)jc;
