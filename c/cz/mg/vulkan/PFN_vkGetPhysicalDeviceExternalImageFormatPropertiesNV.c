...
void Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceExternalImageFormatPropertiesNV_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong format, jlong type, jlong tiling, jlong usage, jlong flags, jlong externalHandleType, jlong pExternalImageFormatProperties, jlong rval){
    (void)env;
    (void)jc;
