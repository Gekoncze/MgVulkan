...
void Java_cz_mg_vulkan_vk_PFNvkCmdPushDescriptorSetWithTemplateKHR_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong descriptorUpdateTemplate, jlong layout, jlong set, jlong pData){
    (void)env;
    (void)jc;
