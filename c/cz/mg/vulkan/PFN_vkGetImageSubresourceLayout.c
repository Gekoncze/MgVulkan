...
void Java_cz_mg_vulkan_PFNvkGetImageSubresourceLayout_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong image, jlong pSubresource, jlong pLayout){
    (void)env;
    (void)jc;
