...
void Java_cz_mg_vulkan_vk_PFNvkCmdBindIndexBuffer_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong buffer, jlong offset, jlong indexType){
    (void)env;
    (void)jc;
