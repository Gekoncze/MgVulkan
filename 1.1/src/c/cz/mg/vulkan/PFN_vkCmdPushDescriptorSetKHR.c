...
void Java_cz_mg_vulkan_PFNvkCmdPushDescriptorSetKHR_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong pipelineBindPoint, jlong layout, jlong set, jlong descriptorWriteCount, jlong pDescriptorWrites){
    (void)env;
    (void)jc;
