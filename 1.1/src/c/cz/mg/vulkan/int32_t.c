...
jint Java_cz_mg_vulkan_VkInt32_getValue(JNIEnv* env, jclass jc, jlong address)
{
    (void)env;
    (void)jc;
    jint value;
...
void Java_cz_mg_vulkan_VkInt32_setValue(JNIEnv* env, jclass jc, jlong address, jint value)
{
    (void)env;
    (void)jc;
