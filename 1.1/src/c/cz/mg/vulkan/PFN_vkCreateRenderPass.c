...
jint Java_cz_mg_vulkan_PFNvkCreateRenderPass_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pRenderPass){
    (void)env;
    (void)jc;
