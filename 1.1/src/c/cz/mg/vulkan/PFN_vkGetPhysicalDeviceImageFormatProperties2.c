...
jint Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceImageFormatProperties2_callNative(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong pImageFormatInfo, jlong pImageFormatProperties){
    (void)env;
    (void)jc;
