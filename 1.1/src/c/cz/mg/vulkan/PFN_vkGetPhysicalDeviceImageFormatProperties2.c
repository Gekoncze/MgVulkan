...
void Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceImageFormatProperties2_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong pImageFormatInfo, jlong pImageFormatProperties, jlong rval){
    (void)env;
    (void)jc;
