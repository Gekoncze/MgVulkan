...
void Java_cz_mg_vulkan_PFNvkCmdFillBuffer_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong dstBuffer, jlong dstOffset, jlong size, jlong data){
    (void)env;
    (void)jc;
