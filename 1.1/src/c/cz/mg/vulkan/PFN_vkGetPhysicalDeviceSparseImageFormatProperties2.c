...
void Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceSparseImageFormatProperties2_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong pFormatInfo, jlong pPropertyCount, jlong pProperties){
    (void)env;
    (void)jc;
