...
jint Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceDisplayPropertiesKHR_callNative(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong pPropertyCount, jlong pProperties){
    (void)env;
    (void)jc;
