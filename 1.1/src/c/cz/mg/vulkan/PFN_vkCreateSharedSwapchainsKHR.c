...
jint Java_cz_mg_vulkan_PFNvkCreateSharedSwapchainsKHR_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jint swapchainCount, jlong pCreateInfos, jlong pAllocator, jlong pSwapchains){
    (void)env;
    (void)jc;
