...
void Java_cz_mg_vulkan_PFNvkDestroyIndirectCommandsLayoutNVX_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong indirectCommandsLayout, jlong pAllocator){
    (void)env;
    (void)jc;
