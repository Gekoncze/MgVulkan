...
void Java_cz_mg_vulkan_PFNvkCreateSampler_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pSampler, jlong rval){
    (void)env;
    (void)jc;
