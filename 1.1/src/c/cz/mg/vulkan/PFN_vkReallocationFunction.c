...
void Java_cz_mg_vulkan_PFNvkReallocationFunction_call(JNIEnv* env, jclass jc, jlong address, jlong pUserData, jlong pOriginal, jlong size, jlong alignment, jlong allocationScope){
    (void)env;
    (void)jc;
