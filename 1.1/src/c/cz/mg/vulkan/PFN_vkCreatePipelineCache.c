...
void Java_cz_mg_vulkan_PFNvkCreatePipelineCache_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pPipelineCache, jlong rval){
    (void)env;
    (void)jc;
