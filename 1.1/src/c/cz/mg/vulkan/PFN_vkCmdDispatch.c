...
void Java_cz_mg_vulkan_PFNvkCmdDispatch_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong groupCountX, jlong groupCountY, jlong groupCountZ){
    (void)env;
    (void)jc;
