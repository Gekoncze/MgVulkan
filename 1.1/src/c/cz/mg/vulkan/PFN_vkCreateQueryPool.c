...
jint Java_cz_mg_vulkan_PFNvkCreateQueryPool_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pQueryPool){
    (void)env;
    (void)jc;
