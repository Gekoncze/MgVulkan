...
jint Java_cz_mg_vulkan_PFNvkGetRefreshCycleDurationGOOGLE_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong swapchain, jlong pDisplayTimingProperties){
    (void)env;
    (void)jc;
