...
void Java_cz_mg_vulkan_PFNvkGetShaderInfoAMD_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pipeline, jlong shaderStage, jlong infoType, jlong pInfoSize, jlong pInfo, jlong rval){
    (void)env;
    (void)jc;
