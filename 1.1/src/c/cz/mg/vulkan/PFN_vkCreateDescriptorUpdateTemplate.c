...
jint Java_cz_mg_vulkan_PFNvkCreateDescriptorUpdateTemplate_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pDescriptorUpdateTemplate){
    (void)env;
    (void)jc;
