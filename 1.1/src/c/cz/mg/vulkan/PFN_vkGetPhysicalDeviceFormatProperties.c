...
void Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceFormatProperties_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong format, jlong pFormatProperties){
    (void)env;
    (void)jc;
