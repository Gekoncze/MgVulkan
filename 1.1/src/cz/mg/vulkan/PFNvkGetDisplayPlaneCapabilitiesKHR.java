...
public class PFNvkGetDisplayPlaneCapabilitiesKHR extends VkFunctionPointer {
    ...
    public void call(VkPhysicalDevice physicalDevice, VkDisplayModeKHR mode, VkUInt32 planeIndex, VkDisplayPlaneCapabilitiesKHR pCapabilities, VkResult rval){
        call(getValue(), physicalDevice != null ? physicalDevice.getVkAddress() : VkPointer.getNullAddressNative(), mode != null ? mode.getVkAddress() : VkPointer.getNullAddressNative(), planeIndex != null ? planeIndex.getVkAddress() : VkPointer.getNullAddressNative(), pCapabilities != null ? pCapabilities.getVkAddress() : VkPointer.NULL, rval != null ? rval.getVkAddress() : VkPointer.getSinkAddressNative());
    }
