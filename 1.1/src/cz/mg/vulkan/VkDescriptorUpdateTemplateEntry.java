...
public class VkDescriptorUpdateTemplateEntry extends VkObject {
    ...
    protected VkDescriptorUpdateTemplateEntry(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkDescriptorUpdateTemplateEntry(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkDescriptorUpdateTemplateEntry(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkDescriptorUpdateTemplateEntry implements cz.mg.collections.array.ReadonlyArray<VkDescriptorUpdateTemplateEntry> {
        ...
        public Array(VkDescriptorUpdateTemplateEntry o, int count){
        ...
        public VkDescriptorUpdateTemplateEntry get(int i){
            return new VkDescriptorUpdateTemplateEntry(getVkMemory(), addressAt(i));
        }
