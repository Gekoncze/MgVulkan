...
public class VkDescriptorUpdateTemplate extends VkNonDispatchableHandle {
    ...
    protected VkDescriptorUpdateTemplate(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkDescriptorUpdateTemplate(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkDescriptorUpdateTemplate(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkDescriptorUpdateTemplate implements cz.mg.collections.array.ReadonlyArray<VkDescriptorUpdateTemplate> {
        ...
        public Array(VkDescriptorUpdateTemplate o, int count){
        ...
        public Array(VkDescriptorUpdateTemplate... values){
            this(values.length);
        ...
        public VkDescriptorUpdateTemplate get(int i){
            return new VkDescriptorUpdateTemplate(getVkMemory(), address(i));
        }
