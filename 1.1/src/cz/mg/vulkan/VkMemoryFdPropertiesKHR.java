...
public class VkMemoryFdPropertiesKHR extends VkObject {
    ...
    protected VkMemoryFdPropertiesKHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkMemoryFdPropertiesKHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkMemoryFdPropertiesKHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkMemoryFdPropertiesKHR implements cz.mg.collections.array.ReadonlyArray<VkMemoryFdPropertiesKHR> {
        ...
        public Array(VkMemoryFdPropertiesKHR o, int count){
