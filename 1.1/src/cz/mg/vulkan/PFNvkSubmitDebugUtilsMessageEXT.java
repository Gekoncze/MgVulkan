...
public class PFNvkSubmitDebugUtilsMessageEXT extends VkFunctionPointer {
    ...
    public void call(VkInstance instance, VkDebugUtilsMessageSeverityFlagBitsEXT messageSeverity, VkDebugUtilsMessageTypeFlagsEXT messageTypes, VkDebugUtilsMessengerCallbackDataEXT pCallbackData){
        call(getValue(), instance != null ? instance.getVkAddress() : VkPointer.getNullAddressNative(), messageSeverity != null ? messageSeverity.getVkAddress() : VkPointer.getNullAddressNative(), messageTypes != null ? messageTypes.getVkAddress() : VkPointer.getNullAddressNative(), pCallbackData != null ? pCallbackData.getVkAddress() : VkPointer.NULL);
    }

    protected static native void call(long vkaddress, long instance, long messageSeverity, long messageTypes, long pCallbackData);
}
