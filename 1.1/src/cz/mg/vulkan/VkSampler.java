...
public class VkSampler extends VkNonDispatchableHandle {
    ...
    protected VkSampler(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkSampler(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkSampler(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkSampler implements cz.mg.collections.array.ReadonlyArray<VkSampler> {
        ...
        public Array(VkSampler o, int count){
        ...
        public VkSampler get(int i){
            return new VkSampler(getVkMemory(), address(i));
        }
