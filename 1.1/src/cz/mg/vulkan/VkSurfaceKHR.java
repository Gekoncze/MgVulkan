...
public class VkSurfaceKHR extends VkNonDispatchableHandle {
    ...
    protected VkSurfaceKHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkSurfaceKHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkSurfaceKHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkSurfaceKHR implements cz.mg.collections.array.ReadonlyArray<VkSurfaceKHR> {
        ...
        public Array(VkSurfaceKHR o, int count){
        ...
        public Array(VkSurfaceKHR... values){
            this(values.length);
