...
public class VkBindBufferMemoryInfo extends VkObject {
    ...
    public static class Array extends VkBindBufferMemoryInfo implements cz.mg.collections.array.ReadonlyArray<VkBindBufferMemoryInfo> {        private final int count;
