...
public class VkSparseImageMemoryBind extends VkObject {
    ...
    public static class Array extends VkSparseImageMemoryBind implements cz.mg.collections.array.ReadonlyArray<VkSparseImageMemoryBind> {        private final int count;
    ...
    public static class Pointer extends VkObject.Pointer {        public Pointer() {
        ...
        public static class Array extends VkSparseImageMemoryBind.Pointer implements cz.mg.collections.array.ReadonlyArray<VkSparseImageMemoryBind.Pointer> {
            ...
            @Override
            public VkSparseImageMemoryBind.Pointer get(int i){
                return new VkSparseImageMemoryBind.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
