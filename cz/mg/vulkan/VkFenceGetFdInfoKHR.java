...
public class VkFenceGetFdInfoKHR extends VkObject {
    ...
    public VkFenceGetFdInfoKHR(VkObject pNext, VkFence fence, VkExternalFenceHandleTypeFlagBits handleType) {
        super(sizeof());
    ...
    public static class Array extends VkFenceGetFdInfoKHR implements cz.mg.collections.array.ReadonlyArray<VkFenceGetFdInfoKHR> {        private final int count;
