...
public class VkPhysicalDeviceFeatures2 extends VkObject {
    ...
    public void setFeatures(VkPhysicalDeviceFeatures features) {
        setFeatures(getVkAddress(), features != null ? features.getVkAddress() : VkPointer.NULL_ADDRESS);
    ...
    public static class Array extends VkPhysicalDeviceFeatures2 implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceFeatures2> {        private final int count;
