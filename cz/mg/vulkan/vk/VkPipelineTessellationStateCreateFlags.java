...
public class VkPipelineTessellationStateCreateFlags extends VkFlags {
    ...
    public static class Array extends VkPipelineTessellationStateCreateFlags implements cz.mg.collections.array.ReadonlyArray<VkPipelineTessellationStateCreateFlags> {
        private final int count;

        public Array(int count) {
            super(new VkMemory(count*VkPipelineTessellationStateCreateFlags.sizeof()));
            this.count = count;
        }

        public Array(int count, VkPipelineTessellationStateCreateFlags o){
        ...
        @Override
        public VkPipelineTessellationStateCreateFlags get(int i){
            return new VkPipelineTessellationStateCreateFlags(getVkMemory(), getVkAddress() + sizeof()*i);
        }
    }
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPipelineTessellationStateCreateFlags.Pointer implements cz.mg.collections.array.ReadonlyArray<Pointer> {
            ...
            public Array(VkPipelineTessellationStateCreateFlags[] a) {
                this(a.length);
