...
public class VkPresentTimesInfoGOOGLE extends VkObject {
    ...
    public VkPresentTimeGOOGLE.Array getPTimes() {
        return new VkPresentTimeGOOGLE.Array(getVkMemory(), getPTimes(getVkAddress()), getSwapchainCount().getValue());
    }

    public void setPTimes(VkPresentTimeGOOGLE pTimes) {
        setPTimes(getVkAddress(), pTimes.getVkAddress());
    }
