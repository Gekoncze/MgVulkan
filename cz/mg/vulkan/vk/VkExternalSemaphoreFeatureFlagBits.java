...
public class VkExternalSemaphoreFeatureFlagBits extends VkFlagBits {
    ...
    public static class Array extends VkExternalSemaphoreFeatureFlagBits implements cz.mg.collections.array.ReadonlyArray<VkExternalSemaphoreFeatureFlagBits> {
        ...
        public Array(int count) {
            super(new VkMemory(count*VkExternalSemaphoreFeatureFlagBits.sizeof()));
            this.count = count;
        }

        public Array(int count, VkExternalSemaphoreFeatureFlagBits o){
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkExternalSemaphoreFeatureFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkExternalSemaphoreFeatureFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkExternalSemaphoreFeatureFlagBits.Pointer get(int i){
                return new VkExternalSemaphoreFeatureFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
