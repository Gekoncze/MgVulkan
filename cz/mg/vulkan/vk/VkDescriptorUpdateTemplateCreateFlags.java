...
public class VkDescriptorUpdateTemplateCreateFlags extends VkFlags {
    ...
    public static class Array extends VkDescriptorUpdateTemplateCreateFlags implements cz.mg.collections.array.ReadonlyArray<VkDescriptorUpdateTemplateCreateFlags> {
        private final int count;

        public Array(int count) {
            super(new VkMemory(count*VkDescriptorUpdateTemplateCreateFlags.sizeof()));
            this.count = count;
        }

        public Array(int count, VkDescriptorUpdateTemplateCreateFlags o){
        ...
        @Override
        public VkDescriptorUpdateTemplateCreateFlags get(int i){
            return new VkDescriptorUpdateTemplateCreateFlags(getVkMemory(), getVkAddress() + sizeof()*i);
        }
    }
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkDescriptorUpdateTemplateCreateFlags.Pointer implements cz.mg.collections.array.ReadonlyArray<Pointer> {
            ...
            public Array(VkDescriptorUpdateTemplateCreateFlags[] a) {
                this(a.length);
