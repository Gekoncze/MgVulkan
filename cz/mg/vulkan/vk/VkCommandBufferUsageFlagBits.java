...
public class VkCommandBufferUsageFlagBits extends VkFlagBits {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkCommandBufferUsageFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkCommandBufferUsageFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkCommandBufferUsageFlagBits.Pointer get(int i){
                return new VkCommandBufferUsageFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
