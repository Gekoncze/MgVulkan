...
public class VkObjectType extends VkEnum {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkObjectType.Pointer implements cz.mg.collections.array.ReadonlyArray<VkObjectType.Pointer> {
            private final int count;
            ...
            @Override
            public VkObjectType.Pointer get(int i){
                return new VkObjectType.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
