...
public class VkDescriptorBindingFlagBitsEXT extends VkFlagBits {
    ...
    public static class Array extends VkDescriptorBindingFlagBitsEXT implements cz.mg.collections.array.ReadonlyArray<VkDescriptorBindingFlagBitsEXT> {
        ...
        public Array(int count) {
            super(new VkMemory(count*VkDescriptorBindingFlagBitsEXT.sizeof()));
            this.count = count;
        }

        public Array(int count, VkDescriptorBindingFlagBitsEXT o){
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkDescriptorBindingFlagBitsEXT.Pointer implements cz.mg.collections.array.ReadonlyArray<VkDescriptorBindingFlagBitsEXT.Pointer> {
            private final int count;
            ...
            @Override
            public VkDescriptorBindingFlagBitsEXT.Pointer get(int i){
                return new VkDescriptorBindingFlagBitsEXT.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
