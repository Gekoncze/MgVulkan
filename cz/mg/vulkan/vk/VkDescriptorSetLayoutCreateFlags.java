...
public class VkDescriptorSetLayoutCreateFlags extends VkFlags {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkDescriptorSetLayoutCreateFlags.Pointer implements cz.mg.collections.array.ReadonlyArray<VkDescriptorSetLayoutCreateFlags.Pointer> {
            private final int count;
            ...
            @Override
            public VkDescriptorSetLayoutCreateFlags.Pointer get(int i){
                return new VkDescriptorSetLayoutCreateFlags.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
