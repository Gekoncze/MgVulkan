...
public class VkBufferUsageFlagBits extends VkFlagBits {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkBufferUsageFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkBufferUsageFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkBufferUsageFlagBits.Pointer get(int i){
                return new VkBufferUsageFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
