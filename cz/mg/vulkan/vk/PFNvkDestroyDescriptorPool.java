...
public class PFNvkDestroyDescriptorPool extends VkFunctionPointer {
    ...
    public void call(VkDevice device, VkDescriptorPool descriptorPool, VkAllocationCallbacks pAllocator){
        call(getValue(), device != null ? device.getVkAddress() : VkDevice.NULL.getVkAddress(), descriptorPool != null ? descriptorPool.getVkAddress() : VkDescriptorPool.NULL.getVkAddress(), pAllocator != null ? pAllocator.getVkAddress() : VkPointer.NULL);
    }
