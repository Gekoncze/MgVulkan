...
public class VkDescriptorSetLayoutCreateInfo extends VkObject {
    ...
    public VkDescriptorSetLayoutBinding.Array getPBindings() {
        return new VkDescriptorSetLayoutBinding.Array(getVkMemory(), getPBindings(getVkAddress()), getBindingCount().getValue());
    }

    public void setPBindings(VkDescriptorSetLayoutBinding pBindings) {
        setPBindings(getVkAddress(), pBindings.getVkAddress());
    }
