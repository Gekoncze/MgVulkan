...
public class VkExternalSemaphoreHandleTypeFlags extends VkFlags {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkExternalSemaphoreHandleTypeFlags.Pointer implements cz.mg.collections.array.ReadonlyArray<VkExternalSemaphoreHandleTypeFlags.Pointer> {
            private final int count;
            ...
            @Override
            public VkExternalSemaphoreHandleTypeFlags.Pointer get(int i){
                return new VkExternalSemaphoreHandleTypeFlags.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
