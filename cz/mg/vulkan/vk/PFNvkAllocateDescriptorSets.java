...
public class PFNvkAllocateDescriptorSets extends VkFunctionPointer {
    ...
    public void call(VkDevice device, VkDescriptorSetAllocateInfo pAllocateInfo, VkDescriptorSet pDescriptorSets, VkResult rval){
        call(getValue(), device != null ? device.getVkAddress() : VkDevice.NULL.getVkAddress(), pAllocateInfo != null ? pAllocateInfo.getVkAddress() : VkPointer.NULL, pDescriptorSets != null ? pDescriptorSets.getVkAddress() : VkDescriptorSet.NULL.getVkAddress(), rval != null ? rval.getVkAddress() : VkPointer.NULL);
    }
