...
public class VkSubgroupFeatureFlagBits extends VkFlagBits {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkSubgroupFeatureFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkSubgroupFeatureFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkSubgroupFeatureFlagBits.Pointer get(int i){
                return new VkSubgroupFeatureFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
