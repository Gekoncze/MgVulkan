...
public class PFNvkGetInstanceProcAddr extends VkFunctionPointer {
    ...
    public void call(VkInstance instance, VkChar pName, PFNvkVoidFunction rval){
        call(getValue(), instance != null ? instance.getVkAddress() : VkInstance.NULL.getVkAddress(), pName != null ? pName.getVkAddress() : VkPointer.NULL, rval != null ? rval.getVkAddress() : VkPointer.NULL);
    }
