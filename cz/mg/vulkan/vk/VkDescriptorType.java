...
public class VkDescriptorType extends VkEnum {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkDescriptorType.Pointer implements cz.mg.collections.array.ReadonlyArray<VkDescriptorType.Pointer> {
            private final int count;
            ...
            @Override
            public VkDescriptorType.Pointer get(int i){
                return new VkDescriptorType.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
