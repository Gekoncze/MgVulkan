...
public class VkPipelineViewportSwizzleStateCreateFlagsNV extends VkFlags {
    ...
    public static class Array extends VkPipelineViewportSwizzleStateCreateFlagsNV implements cz.mg.collections.array.ReadonlyArray<VkPipelineViewportSwizzleStateCreateFlagsNV> {
        ...
        public Array(int count) {
            super(new VkMemory(count*VkPipelineViewportSwizzleStateCreateFlagsNV.sizeof()));
            this.count = count;
        }

        public Array(int count, VkPipelineViewportSwizzleStateCreateFlagsNV o){
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPipelineViewportSwizzleStateCreateFlagsNV.Pointer implements cz.mg.collections.array.ReadonlyArray<VkPipelineViewportSwizzleStateCreateFlagsNV.Pointer> {
            private final int count;
            ...
            @Override
            public VkPipelineViewportSwizzleStateCreateFlagsNV.Pointer get(int i){
                return new VkPipelineViewportSwizzleStateCreateFlagsNV.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
