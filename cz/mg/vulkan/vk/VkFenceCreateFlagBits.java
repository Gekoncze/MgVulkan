...
public class VkFenceCreateFlagBits extends VkFlagBits {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkFenceCreateFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkFenceCreateFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkFenceCreateFlagBits.Pointer get(int i){
                return new VkFenceCreateFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
