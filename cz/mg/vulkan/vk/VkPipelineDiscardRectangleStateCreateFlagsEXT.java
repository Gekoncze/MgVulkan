...
public class VkPipelineDiscardRectangleStateCreateFlagsEXT extends VkFlags {
    ...
    public static class Array extends VkPipelineDiscardRectangleStateCreateFlagsEXT implements cz.mg.collections.array.ReadonlyArray<VkPipelineDiscardRectangleStateCreateFlagsEXT> {
        ...
        public Array(int count) {
            super(new VkMemory(count*VkPipelineDiscardRectangleStateCreateFlagsEXT.sizeof()));
            this.count = count;
        }

        public Array(int count, VkPipelineDiscardRectangleStateCreateFlagsEXT o){
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPipelineDiscardRectangleStateCreateFlagsEXT.Pointer implements cz.mg.collections.array.ReadonlyArray<VkPipelineDiscardRectangleStateCreateFlagsEXT.Pointer> {
            private final int count;
            ...
            @Override
            public VkPipelineDiscardRectangleStateCreateFlagsEXT.Pointer get(int i){
                return new VkPipelineDiscardRectangleStateCreateFlagsEXT.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
