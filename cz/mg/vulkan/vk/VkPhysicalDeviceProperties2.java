...
/**
 *  @see <a href="https://www.khronos.org/registry/vulkan/specs/1.1-extensions/man/html/VkPhysicalDeviceProperties2.html">khronos documentation</a>
 **/
public class VkPhysicalDeviceProperties2 extends VkObject {
    ...
    public VkPhysicalDeviceProperties2(VkStructureType sType, VkObject pNext, VkPhysicalDeviceProperties properties) {
        super(sizeof());
        setSType(sType);
        setPNext(pNext);
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPhysicalDeviceProperties2.Pointer implements cz.mg.collections.array.ReadonlyArray<Pointer> {
            private final int count;
