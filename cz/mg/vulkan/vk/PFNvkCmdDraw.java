...
public class PFNvkCmdDraw extends VkFunctionPointer {
    ...
    public void call(VkCommandBuffer commandBuffer, VkUInt32 vertexCount, VkUInt32 instanceCount, VkUInt32 firstVertex, VkUInt32 firstInstance){
        call(getValue(), commandBuffer != null ? commandBuffer.getVkAddress() : VkCommandBuffer.NULL.getVkAddress(), vertexCount != null ? vertexCount.getVkAddress() : VkPointer.NULL, instanceCount != null ? instanceCount.getVkAddress() : VkPointer.NULL, firstVertex != null ? firstVertex.getVkAddress() : VkPointer.NULL, firstInstance != null ? firstInstance.getVkAddress() : VkPointer.NULL);
    }
