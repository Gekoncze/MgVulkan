...
public class VkExternalMemoryFeatureFlagBits extends VkFlagBits {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkExternalMemoryFeatureFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkExternalMemoryFeatureFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkExternalMemoryFeatureFlagBits.Pointer get(int i){
                return new VkExternalMemoryFeatureFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
