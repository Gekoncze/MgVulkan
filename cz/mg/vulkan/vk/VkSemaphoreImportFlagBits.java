...
public class VkSemaphoreImportFlagBits extends VkFlagBits {
    ...
    public static class Array extends VkSemaphoreImportFlagBits implements cz.mg.collections.array.ReadonlyArray<VkSemaphoreImportFlagBits> {
        ...
        public Array(int count) {
            super(new VkMemory(count*VkSemaphoreImportFlagBits.sizeof()));
            this.count = count;
        }

        public Array(int count, VkSemaphoreImportFlagBits o){
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkSemaphoreImportFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkSemaphoreImportFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkSemaphoreImportFlagBits.Pointer get(int i){
                return new VkSemaphoreImportFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
