...
public class PFNvkDestroyDebugUtilsMessengerEXT extends VkFunctionPointer {
    ...
    public void call(VkInstance instance, VkDebugUtilsMessengerEXT messenger, VkAllocationCallbacks pAllocator){
        call(getValue(), instance != null ? instance.getVkAddress() : VkInstance.NULL.getVkAddress(), messenger != null ? messenger.getVkAddress() : VkDebugUtilsMessengerEXT.NULL.getVkAddress(), pAllocator != null ? pAllocator.getVkAddress() : VkPointer.NULL);
    }
