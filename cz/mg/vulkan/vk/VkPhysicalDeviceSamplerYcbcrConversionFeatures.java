...
public class VkPhysicalDeviceSamplerYcbcrConversionFeatures extends VkObject {
    ...
    public void setSamplerYcbcrConversion(VkBool32 samplerYcbcrConversion) {
        setSamplerYcbcrConversion(getVkAddress(), samplerYcbcrConversion != null ? samplerYcbcrConversion.getVkAddress() : VkPointer.NULL_ADDRESS);
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPhysicalDeviceSamplerYcbcrConversionFeatures.Pointer implements cz.mg.collections.array.ReadonlyArray<Pointer> {
            private final int count;
