...
public class VkDescriptorPoolCreateFlagBits extends VkFlagBits {
    ...
    public static class Array extends VkDescriptorPoolCreateFlagBits implements cz.mg.collections.array.ReadonlyArray<VkDescriptorPoolCreateFlagBits> {
        ...
        public Array(int count) {
            super(new VkMemory(count*VkDescriptorPoolCreateFlagBits.sizeof()));
            this.count = count;
        }

        public Array(int count, VkDescriptorPoolCreateFlagBits o){
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkDescriptorPoolCreateFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkDescriptorPoolCreateFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkDescriptorPoolCreateFlagBits.Pointer get(int i){
                return new VkDescriptorPoolCreateFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
