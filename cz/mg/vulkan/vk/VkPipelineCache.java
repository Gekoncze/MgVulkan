...
public class VkPipelineCache extends VkNonDispatchableHandle {
    ...
    public static class Array extends VkPipelineCache implements cz.mg.collections.array.ReadonlyArray<VkPipelineCache> {
        ...
        public VkPipelineCache get(int i){
            return new VkPipelineCache(getVkMemory(), getVkAddress() + sizeof()*i);
        }
    }
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPipelineCache.Pointer implements cz.mg.collections.array.ReadonlyArray<VkPipelineCache.Pointer> {
            private final int count;
            ...
            public Array(VkPipelineCache[] a) {
                this(a.length);
            ...
            @Override
            public VkPipelineCache.Pointer get(int i){
                return new VkPipelineCache.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
