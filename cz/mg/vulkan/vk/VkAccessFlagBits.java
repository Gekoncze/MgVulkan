...
public class VkAccessFlagBits extends VkFlagBits {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkAccessFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkAccessFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkAccessFlagBits.Pointer get(int i){
                return new VkAccessFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
