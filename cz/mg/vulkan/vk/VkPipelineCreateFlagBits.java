...
public class VkPipelineCreateFlagBits extends VkFlagBits {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPipelineCreateFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkPipelineCreateFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkPipelineCreateFlagBits.Pointer get(int i){
                return new VkPipelineCreateFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
