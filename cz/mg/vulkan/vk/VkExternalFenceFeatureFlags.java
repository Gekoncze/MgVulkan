...
public class VkExternalFenceFeatureFlags extends VkFlags {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkExternalFenceFeatureFlags.Pointer implements cz.mg.collections.array.ReadonlyArray<VkExternalFenceFeatureFlags.Pointer> {
            private final int count;
            ...
            @Override
            public VkExternalFenceFeatureFlags.Pointer get(int i){
                return new VkExternalFenceFeatureFlags.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
