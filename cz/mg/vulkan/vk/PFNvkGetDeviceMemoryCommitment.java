...
public class PFNvkGetDeviceMemoryCommitment extends VkFunctionPointer {
    ...
    public void call(VkDevice device, VkDeviceMemory memory, VkDeviceSize pCommittedMemoryInBytes){
        call(getValue(), device != null ? device.getVkAddress() : VkDevice.NULL.getVkAddress(), memory != null ? memory.getVkAddress() : VkDeviceMemory.NULL.getVkAddress(), pCommittedMemoryInBytes != null ? pCommittedMemoryInBytes.getVkAddress() : VkPointer.NULL);
    }
