...
public class VkImageCreateFlagBits extends VkFlagBits {
    ...
    public static class Array extends VkImageCreateFlagBits implements cz.mg.collections.array.ReadonlyArray<VkImageCreateFlagBits> {
        ...
        public Array(int count) {
            super(new VkMemory(count*VkImageCreateFlagBits.sizeof()));
            this.count = count;
        }

        public Array(int count, VkImageCreateFlagBits o){
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkImageCreateFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkImageCreateFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkImageCreateFlagBits.Pointer get(int i){
                return new VkImageCreateFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
