...
public class VkImageUsageFlagBits extends VkFlagBits {
    ...
    public static class Array extends VkImageUsageFlagBits implements cz.mg.collections.array.ReadonlyArray<VkImageUsageFlagBits> {
        ...
        public Array(int count) {
            super(new VkMemory(count*VkImageUsageFlagBits.sizeof()));
            this.count = count;
        }

        public Array(int count, VkImageUsageFlagBits o){
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkImageUsageFlagBits.Pointer implements cz.mg.collections.array.ReadonlyArray<VkImageUsageFlagBits.Pointer> {
            private final int count;
            ...
            @Override
            public VkImageUsageFlagBits.Pointer get(int i){
                return new VkImageUsageFlagBits.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
