...
public class VkPipeline extends VkNonDispatchableHandle {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPipeline.Pointer implements cz.mg.collections.array.ReadonlyArray<VkPipeline.Pointer> {
            private final int count;
            ...
            @Override
            public VkPipeline.Pointer get(int i){
                return new VkPipeline.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
