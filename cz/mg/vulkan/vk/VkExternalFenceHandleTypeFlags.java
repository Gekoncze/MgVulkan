...
public class VkExternalFenceHandleTypeFlags extends VkFlags {
    ...
    public static class Array extends VkExternalFenceHandleTypeFlags implements cz.mg.collections.array.ReadonlyArray<VkExternalFenceHandleTypeFlags> {
        private final int count;

        public Array(int count) {
            super(new VkMemory(count*VkExternalFenceHandleTypeFlags.sizeof()));
            this.count = count;
        }

        public Array(int count, VkExternalFenceHandleTypeFlags o){
        ...
        @Override
        public VkExternalFenceHandleTypeFlags get(int i){
            return new VkExternalFenceHandleTypeFlags(getVkMemory(), getVkAddress() + sizeof()*i);
        }
    }
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkExternalFenceHandleTypeFlags.Pointer implements cz.mg.collections.array.ReadonlyArray<Pointer> {
            ...
            public Array(VkExternalFenceHandleTypeFlags[] a) {
                this(a.length);
