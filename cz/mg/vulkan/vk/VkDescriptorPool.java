...
public class VkDescriptorPool extends VkNonDispatchableHandle {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkDescriptorPool.Pointer implements cz.mg.collections.array.ReadonlyArray<VkDescriptorPool.Pointer> {
            private final int count;
            ...
            @Override
            public VkDescriptorPool.Pointer get(int i){
                return new VkDescriptorPool.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
