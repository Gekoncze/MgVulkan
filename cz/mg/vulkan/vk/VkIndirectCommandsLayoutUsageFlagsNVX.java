...
public class VkIndirectCommandsLayoutUsageFlagsNVX extends VkFlags {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkIndirectCommandsLayoutUsageFlagsNVX.Pointer implements cz.mg.collections.array.ReadonlyArray<VkIndirectCommandsLayoutUsageFlagsNVX.Pointer> {
            private final int count;
            ...
            @Override
            public VkIndirectCommandsLayoutUsageFlagsNVX.Pointer get(int i){
                return new VkIndirectCommandsLayoutUsageFlagsNVX.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
