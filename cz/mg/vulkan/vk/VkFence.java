...
public class VkFence extends VkNonDispatchableHandle {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkFence.Pointer implements cz.mg.collections.array.ReadonlyArray<VkFence.Pointer> {
            private final int count;
            ...
            @Override
            public VkFence.Pointer get(int i){
                return new VkFence.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
