...
public class VkSwapchainCreateFlagsKHR extends VkFlags {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkSwapchainCreateFlagsKHR.Pointer implements cz.mg.collections.array.ReadonlyArray<VkSwapchainCreateFlagsKHR.Pointer> {
            private final int count;
            ...
            @Override
            public VkSwapchainCreateFlagsKHR.Pointer get(int i){
                return new VkSwapchainCreateFlagsKHR.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
