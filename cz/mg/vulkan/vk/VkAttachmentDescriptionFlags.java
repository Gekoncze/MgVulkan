...
public class VkAttachmentDescriptionFlags extends VkFlags {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkAttachmentDescriptionFlags.Pointer implements cz.mg.collections.array.ReadonlyArray<VkAttachmentDescriptionFlags.Pointer> {
            private final int count;
            ...
            @Override
            public VkAttachmentDescriptionFlags.Pointer get(int i){
                return new VkAttachmentDescriptionFlags.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
