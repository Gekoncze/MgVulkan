...
public class VkCmdProcessCommandsInfoNVX extends VkObject {
    ...
    public void setIndirectCommandsTokenCount(VkUInt32 indirectCommandsTokenCount) {
        setIndirectCommandsTokenCount(getVkAddress(), indirectCommandsTokenCount.getVkAddress());
    }
    ...
    public VkIndirectCommandsTokenNVX.Array getPIndirectCommandsTokens() {
        return new VkIndirectCommandsTokenNVX.Array(getVkMemory(), getPIndirectCommandsTokens(getVkAddress()), getIndirectCommandsTokenCount().getValue());
    }

    public void setPIndirectCommandsTokens(VkIndirectCommandsTokenNVX pIndirectCommandsTokens) {
        setPIndirectCommandsTokens(getVkAddress(), pIndirectCommandsTokens.getVkAddress());
    }
    ...
    public VkCommandBuffer.Array getTargetCommandBuffer() {
        return new VkCommandBuffer.Array(getVkMemory(), getTargetCommandBuffer(getVkAddress()), getMaxSequencesCount().getValue());
    }

    public void setTargetCommandBuffer(VkCommandBuffer targetCommandBuffer) {
        setTargetCommandBuffer(getVkAddress(), targetCommandBuffer.getVkAddress());
    }
    ...
    public void setSequencesCountBuffer(VkBuffer sequencesCountBuffer) {
        setSequencesCountBuffer(getVkAddress(), sequencesCountBuffer.getVkAddress());
    }
    ...
    public void setSequencesCountOffset(VkDeviceSize sequencesCountOffset) {
        setSequencesCountOffset(getVkAddress(), sequencesCountOffset.getVkAddress());
    }
    ...
    public void setSequencesIndexBuffer(VkBuffer sequencesIndexBuffer) {
        setSequencesIndexBuffer(getVkAddress(), sequencesIndexBuffer.getVkAddress());
    }
    ...
    public void setSequencesIndexOffset(VkDeviceSize sequencesIndexOffset) {
        setSequencesIndexOffset(getVkAddress(), sequencesIndexOffset.getVkAddress());
    }
