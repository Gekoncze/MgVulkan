...
public class VkExternalMemoryFeatureFlags extends VkFlags {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkExternalMemoryFeatureFlags.Pointer implements cz.mg.collections.array.ReadonlyArray<VkExternalMemoryFeatureFlags.Pointer> {
            private final int count;
            ...
            @Override
            public VkExternalMemoryFeatureFlags.Pointer get(int i){
                return new VkExternalMemoryFeatureFlags.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
