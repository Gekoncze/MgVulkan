...
public class VkPhysicalDeviceDiscardRectanglePropertiesEXT extends VkObject {
    ...
    public void setMaxDiscardRectangles(VkUInt32 maxDiscardRectangles) {
        setMaxDiscardRectangles(getVkAddress(), maxDiscardRectangles != null ? maxDiscardRectangles.getVkAddress() : VkPointer.NULL_ADDRESS);
    ...
    public static class Array extends VkPhysicalDeviceDiscardRectanglePropertiesEXT implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceDiscardRectanglePropertiesEXT> {        private final int count;
