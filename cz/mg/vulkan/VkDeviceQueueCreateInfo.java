...
public class VkDeviceQueueCreateInfo extends VkObject {
    ...
    public static class Array extends VkDeviceQueueCreateInfo implements cz.mg.collections.array.ReadonlyArray<VkDeviceQueueCreateInfo> {        private final int count;
