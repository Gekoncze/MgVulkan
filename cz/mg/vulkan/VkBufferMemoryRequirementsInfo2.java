...
public class VkBufferMemoryRequirementsInfo2 extends VkObject {
    ...
    public static class Array extends VkBufferMemoryRequirementsInfo2 implements cz.mg.collections.array.ReadonlyArray<VkBufferMemoryRequirementsInfo2> {        private final int count;
    ...
    public static class Pointer extends VkObject.Pointer {        public Pointer() {
        ...
        public static class Array extends VkBufferMemoryRequirementsInfo2.Pointer implements cz.mg.collections.array.ReadonlyArray<VkBufferMemoryRequirementsInfo2.Pointer> {
            ...
            @Override
            public VkBufferMemoryRequirementsInfo2.Pointer get(int i){
                return new VkBufferMemoryRequirementsInfo2.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
