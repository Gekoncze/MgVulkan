...
public class VkImageView extends Structure {
    ...
    public static class ByReference extends VkImageView implements Structure.ByReference {
        public ByReference(){
        }
    ...
    public static class ByValue extends VkImageView implements Structure.ByValue {
        public ByValue(){
        }
