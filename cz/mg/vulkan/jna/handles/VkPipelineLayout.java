 ...
 **/
public class VkPipelineLayout extends Structure {
    public Pointer ptr;

    public VkPipelineLayout() {
    }

    public VkPipelineLayout(Pointer pointer) {
        super(pointer);
    }
    ...
    public static class ByReference extends VkPipelineLayout implements Structure.ByReference {
        public ByReference(){
        }
    ...
    public static class ByValue extends VkPipelineLayout implements Structure.ByValue {
        public ByValue(){
        }
