 ...
 **/
public class VkFormat extends Structure {
    ...
    public VkFormat(Pointer p) {
        super(p);
    }

    public static class ByReference extends VkFormat implements Structure.ByReference {
        public ByReference() {
        }
    ...
    public static class ByValue extends VkFormat implements Structure.ByValue {
        public ByValue() {
        }
