 ...
 **/
public class VkStructureType extends Structure {
    ...
    public static final int VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_EXT = 1000158001;
    ...
    public VkStructureType(Pointer p) {
        super(p);
    }

    public static class ByReference extends VkStructureType implements Structure.ByReference {
        public ByReference() {
        }
    ...
    public static class ByValue extends VkStructureType implements Structure.ByValue {
        public ByValue() {
        }
