...
public class VkShaderModuleCreateInfo extends VkObject {
    ...
    public static class Array extends VkShaderModuleCreateInfo implements cz.mg.collections.array.ReadonlyArray<VkShaderModuleCreateInfo> {        private final int count;
