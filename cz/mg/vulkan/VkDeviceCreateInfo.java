...
public class VkDeviceCreateInfo extends VkObject {
    ...
    public void setQueueCreateInfoCount(VkUInt32 queueCreateInfoCount) {
        setQueueCreateInfoCount(getVkAddress(), queueCreateInfoCount != null ? queueCreateInfoCount.getVkAddress() : VkPointer.NULL_ADDRESS);
    ...
    public static class Array extends VkDeviceCreateInfo implements cz.mg.collections.array.ReadonlyArray<VkDeviceCreateInfo> {        private final int count;
