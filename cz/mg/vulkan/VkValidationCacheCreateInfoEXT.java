...
public class VkValidationCacheCreateInfoEXT extends VkObject {
    ...
    public void setInitialDataSize(VkSize initialDataSize) {
        setInitialDataSize(getVkAddress(), initialDataSize != null ? initialDataSize.getVkAddress() : VkPointer.NULL_ADDRESS);
    ...
    public static class Array extends VkValidationCacheCreateInfoEXT implements cz.mg.collections.array.ReadonlyArray<VkValidationCacheCreateInfoEXT> {        private final int count;
