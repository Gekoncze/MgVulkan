...
public class PFNvkGetDeviceQueue2 extends VkFunctionPointer {
    ...
    public void call(VkDevice device, VkDeviceQueueInfo2 pQueueInfo, VkQueue pQueue){
        call(getValue(), device != null ? device.getVkAddress() : VkPointer.getSinkAddress(), pQueueInfo != null ? pQueueInfo.getVkAddress() : VkPointer.NULL, pQueue != null ? pQueue.getVkAddress() : VkPointer.NULL);
    }
