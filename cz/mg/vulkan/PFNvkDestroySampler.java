...
public class PFNvkDestroySampler extends VkFunctionPointer {
    ...
    public void call(VkDevice device, VkSampler sampler, VkAllocationCallbacks pAllocator){
        call(getValue(), device != null ? device.getVkAddress() : VkPointer.getSinkAddress(), sampler != null ? sampler.getVkAddress() : VkPointer.getSinkAddress(), pAllocator != null ? pAllocator.getVkAddress() : VkPointer.NULL);
    }
