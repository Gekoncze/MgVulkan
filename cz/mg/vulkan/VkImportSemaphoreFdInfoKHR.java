...
public class VkImportSemaphoreFdInfoKHR extends VkObject {
    ...
    public static class Array extends VkImportSemaphoreFdInfoKHR implements cz.mg.collections.array.ReadonlyArray<VkImportSemaphoreFdInfoKHR> {        private final int count;
