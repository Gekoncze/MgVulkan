...
public class VkCommandBufferAllocateInfo extends VkObject {
    ...
    public static class Array extends VkCommandBufferAllocateInfo implements cz.mg.collections.array.ReadonlyArray<VkCommandBufferAllocateInfo> {        private final int count;
