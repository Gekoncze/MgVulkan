...
public class VkSamplerReductionModeCreateInfoEXT extends VkObject {
    ...
    public void setReductionMode(VkSamplerReductionModeEXT reductionMode) {
        setReductionMode(getVkAddress(), reductionMode != null ? reductionMode.getVkAddress() : VkPointer.getSinkAddress());
    ...
    public static class Array extends VkSamplerReductionModeCreateInfoEXT implements cz.mg.collections.array.ReadonlyArray<VkSamplerReductionModeCreateInfoEXT> {        private final int count;
    ...
    public static class Pointer extends VkObject.Pointer {        public Pointer() {
        ...
        public static class Array extends VkSamplerReductionModeCreateInfoEXT.Pointer implements cz.mg.collections.array.ReadonlyArray<VkSamplerReductionModeCreateInfoEXT.Pointer> {
            ...
            @Override
            public VkSamplerReductionModeCreateInfoEXT.Pointer get(int i){
                return new VkSamplerReductionModeCreateInfoEXT.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
