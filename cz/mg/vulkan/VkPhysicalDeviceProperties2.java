...
public class VkPhysicalDeviceProperties2 extends VkObject {
    ...
    public static class Array extends VkPhysicalDeviceProperties2 implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceProperties2> {        private final int count;
