...
public class VkSamplerYcbcrConversionImageFormatProperties extends VkObject {
    ...
    public void setCombinedImageSamplerDescriptorCount(VkUInt32 combinedImageSamplerDescriptorCount) {
        setCombinedImageSamplerDescriptorCount(getVkAddress(), combinedImageSamplerDescriptorCount != null ? combinedImageSamplerDescriptorCount.getVkAddress() : VkPointer.getSinkAddress());
    ...
    public static class Array extends VkSamplerYcbcrConversionImageFormatProperties implements cz.mg.collections.array.ReadonlyArray<VkSamplerYcbcrConversionImageFormatProperties> {        private final int count;
