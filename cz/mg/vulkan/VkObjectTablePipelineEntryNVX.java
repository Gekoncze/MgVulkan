...
public class VkObjectTablePipelineEntryNVX extends VkObject {
    ...
    public void setPipeline(VkPipeline pipeline) {
        setPipeline(getVkAddress(), pipeline != null ? pipeline.getVkAddress() : VkPointer.NULL_ADDRESS);
    ...
    public static class Array extends VkObjectTablePipelineEntryNVX implements cz.mg.collections.array.ReadonlyArray<VkObjectTablePipelineEntryNVX> {        private final int count;
