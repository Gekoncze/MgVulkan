...
public class VkDisplayModePropertiesKHR extends VkObject {
    ...
    public static class Array extends VkDisplayModePropertiesKHR implements cz.mg.collections.array.ReadonlyArray<VkDisplayModePropertiesKHR> {        private final int count;
