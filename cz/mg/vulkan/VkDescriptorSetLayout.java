...
public class VkDescriptorSetLayout extends VkNonDispatchableHandle {
    ...
    public static class Array extends VkDescriptorSetLayout implements cz.mg.collections.array.ReadonlyArray<VkDescriptorSetLayout> {        private final int count;
