...
public class VkMemoryAllocateFlagsInfo extends VkObject {
    ...
    public static class Array extends VkMemoryAllocateFlagsInfo implements cz.mg.collections.array.ReadonlyArray<VkMemoryAllocateFlagsInfo> {        private final int count;
