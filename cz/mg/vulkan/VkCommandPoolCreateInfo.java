...
public class VkCommandPoolCreateInfo extends VkObject {
    ...
    public static class Array extends VkCommandPoolCreateInfo implements cz.mg.collections.array.ReadonlyArray<VkCommandPoolCreateInfo> {        private final int count;
