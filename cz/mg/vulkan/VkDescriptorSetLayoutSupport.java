...
public class VkDescriptorSetLayoutSupport extends VkObject {
    ...
    public static class Array extends VkDescriptorSetLayoutSupport implements cz.mg.collections.array.ReadonlyArray<VkDescriptorSetLayoutSupport> {        private final int count;
