...
public class VkSamplerYcbcrConversionInfo extends VkObject {
    ...
    public void setConversion(VkSamplerYcbcrConversion conversion) {
        setConversion(getVkAddress(), conversion != null ? conversion.getVkAddress() : VkPointer.getSinkAddress());
    ...
    public static class Array extends VkSamplerYcbcrConversionInfo implements cz.mg.collections.array.ReadonlyArray<VkSamplerYcbcrConversionInfo> {        private final int count;
