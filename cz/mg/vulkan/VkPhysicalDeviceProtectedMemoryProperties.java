...
public class VkPhysicalDeviceProtectedMemoryProperties extends VkObject {
    ...
    public void setProtectedNoFault(VkBool32 protectedNoFault) {
        setProtectedNoFault(getVkAddress(), protectedNoFault != null ? protectedNoFault.getVkAddress() : VkPointer.NULL_ADDRESS);
    ...
    public static class Array extends VkPhysicalDeviceProtectedMemoryProperties implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceProtectedMemoryProperties> {        private final int count;
