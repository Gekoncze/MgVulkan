...
public class VkMemoryHostPointerPropertiesEXT extends VkObject {
    ...
    public VkMemoryHostPointerPropertiesEXT(VkMemory vkmemory) {
        super(vkmemory);
    }

    public VkMemoryHostPointerPropertiesEXT(VkMemory vkmemory, long vkaddress) {
    ...
    public static class Array extends VkMemoryHostPointerPropertiesEXT implements cz.mg.collections.array.ReadonlyArray<VkMemoryHostPointerPropertiesEXT> {        private final int count;
        ...
        public Array(int count, VkMemoryHostPointerPropertiesEXT o){
    ...
    public static class Pointer extends VkObject.Pointer {        public Pointer() {
        ...
        public static class Array extends VkMemoryHostPointerPropertiesEXT.Pointer implements cz.mg.collections.array.ReadonlyArray<VkMemoryHostPointerPropertiesEXT.Pointer> {
            ...
            public Array(VkMemoryHostPointerPropertiesEXT[] a) {
                this(a.length);
