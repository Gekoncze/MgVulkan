...
public class VkImageViewUsageCreateInfo extends VkObject {
    ...
    public static class Array extends VkImageViewUsageCreateInfo implements cz.mg.collections.array.ReadonlyArray<VkImageViewUsageCreateInfo> {        private final int count;
