...
public class VkPhysicalDeviceProtectedMemoryFeatures extends VkObject {
    ...
    public void setProtectedMemory(VkBool32 protectedMemory) {
        setProtectedMemory(getVkAddress(), protectedMemory != null ? protectedMemory.getVkAddress() : VkPointer.getSinkAddress());
    ...
    public static class Array extends VkPhysicalDeviceProtectedMemoryFeatures implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceProtectedMemoryFeatures> {        private final int count;
