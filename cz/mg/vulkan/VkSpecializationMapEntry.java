...
public class VkSpecializationMapEntry extends VkObject {
    ...
    public void setConstantID(VkUInt32 constantID) {
        setConstantID(getVkAddress(), constantID != null ? constantID.getVkAddress() : VkPointer.getSinkAddress());
    ...
    public static class Array extends VkSpecializationMapEntry implements cz.mg.collections.array.ReadonlyArray<VkSpecializationMapEntry> {        private final int count;
