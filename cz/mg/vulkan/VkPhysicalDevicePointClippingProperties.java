...
public class VkPhysicalDevicePointClippingProperties extends VkObject {
    ...
    public void setPointClippingBehavior(VkPointClippingBehavior pointClippingBehavior) {
        setPointClippingBehavior(getVkAddress(), pointClippingBehavior != null ? pointClippingBehavior.getVkAddress() : VkPointer.NULL_ADDRESS);
    ...
    public static class Array extends VkPhysicalDevicePointClippingProperties implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDevicePointClippingProperties> {        private final int count;
