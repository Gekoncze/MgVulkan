...
public class VkProtectedSubmitInfo extends VkObject {
    ...
    public void setProtectedSubmit(VkBool32 protectedSubmit) {
        setProtectedSubmit(getVkAddress(), protectedSubmit != null ? protectedSubmit.getVkAddress() : VkPointer.getSinkAddress());
        
    }

    private static native long getProtectedSubmit(long address);
    private static native void setProtectedSubmit(long address, long protectedSubmit);


    public static native long sizeof();

    public static class Array extends VkProtectedSubmitInfo implements cz.mg.collections.array.ReadonlyArray<VkProtectedSubmitInfo> {        private final int count;
