...
public class PFNvkDestroyQueryPool extends VkFunctionPointer {
    ...
    public void call(VkDevice device, VkQueryPool queryPool, VkAllocationCallbacks pAllocator){
        call(getValue(), device != null ? device.getVkAddress() : VkPointer.getSinkAddress(), queryPool != null ? queryPool.getVkAddress() : VkPointer.getSinkAddress(), pAllocator != null ? pAllocator.getVkAddress() : VkPointer.NULL);
    }
