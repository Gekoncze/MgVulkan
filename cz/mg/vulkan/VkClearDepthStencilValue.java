...
public class VkClearDepthStencilValue extends VkObject {
    ...
    public void setStencil(VkUInt32 stencil) {
        setStencil(getVkAddress(), stencil != null ? stencil.getVkAddress() : VkPointer.getSinkAddress());
    ...
    public static class Array extends VkClearDepthStencilValue implements cz.mg.collections.array.ReadonlyArray<VkClearDepthStencilValue> {        private final int count;
