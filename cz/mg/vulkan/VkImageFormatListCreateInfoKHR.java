...
public class VkImageFormatListCreateInfoKHR extends VkObject {
    ...
    public void setViewFormatCount(VkUInt32 viewFormatCount) {
        setViewFormatCount(getVkAddress(), viewFormatCount != null ? viewFormatCount.getVkAddress() : VkPointer.getSinkAddress());
    ...
    public static class Array extends VkImageFormatListCreateInfoKHR implements cz.mg.collections.array.ReadonlyArray<VkImageFormatListCreateInfoKHR> {        private final int count;
