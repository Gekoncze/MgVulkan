...
public class VkUInt64 extends VkObject {
    ...
    public static class Array extends VkUInt64 implements cz.mg.collections.array.ReadonlyArray<VkUInt64> {        private final int count;
    ...
    public static class Pointer extends VkObject.Pointer {        public Pointer() {
        ...
        public static class Array extends VkUInt64.Pointer implements cz.mg.collections.array.ReadonlyArray<VkUInt64.Pointer> {
            ...
            @Override
            public VkUInt64.Pointer get(int i){
                return new VkUInt64.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
