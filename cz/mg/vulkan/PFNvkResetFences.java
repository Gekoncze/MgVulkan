...
public class PFNvkResetFences extends VkFunctionPointer {
    ...
    public void call(VkDevice device, VkUInt32 fenceCount, VkFence pFences, VkResult rval){
        call(getValue(), device != null ? device.getVkAddress() : VkPointer.getSinkAddress(), fenceCount != null ? fenceCount.getVkAddress() : VkPointer.getSinkAddress(), pFences != null ? pFences.getVkAddress() : VkPointer.NULL, rval != null ? rval.getVkAddress() : VkPointer.getSinkAddress());
    }
