...
public class PFNvkDestroyCommandPool extends VkFunctionPointer {
    ...
    public void call(VkDevice device, VkCommandPool commandPool, VkAllocationCallbacks pAllocator){
        call(getValue(), device != null ? device.getVkAddress() : VkPointer.NULL_ADDRESS, commandPool != null ? commandPool.getVkAddress() : VkPointer.NULL_ADDRESS, pAllocator != null ? pAllocator.getVkAddress() : VkPointer.NULL);
    }
