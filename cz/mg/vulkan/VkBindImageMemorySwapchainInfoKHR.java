...
public class VkBindImageMemorySwapchainInfoKHR extends VkObject {
    ...
    public VkBindImageMemorySwapchainInfoKHR(VkObject pNext, VkSwapchainKHR swapchain, VkUInt32 imageIndex) {
        super(sizeof());
    ...
    public void setImageIndex(VkUInt32 imageIndex) {
        setImageIndex(getVkAddress(), imageIndex != null ? imageIndex.getVkAddress() : VkPointer.getSinkAddress());
    ...
    public static class Array extends VkBindImageMemorySwapchainInfoKHR implements cz.mg.collections.array.ReadonlyArray<VkBindImageMemorySwapchainInfoKHR> {        private final int count;
