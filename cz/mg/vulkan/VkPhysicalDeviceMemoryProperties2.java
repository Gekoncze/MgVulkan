...
public class VkPhysicalDeviceMemoryProperties2 extends VkObject {
    ...
    public void setMemoryProperties(VkPhysicalDeviceMemoryProperties memoryProperties) {
        setMemoryProperties(getVkAddress(), memoryProperties != null ? memoryProperties.getVkAddress() : VkPointer.getSinkAddress());
    ...
    public static class Array extends VkPhysicalDeviceMemoryProperties2 implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceMemoryProperties2> {        private final int count;
