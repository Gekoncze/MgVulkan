...
public class FlagsGenerator extends javax.swing.JFrame {
    ...
    */
    ...
    private String readAll(){
        InputStream stream = getClass().getResourceAsStream("FlagsSample.txt");
    ...
    */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FlagsGenerator.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FlagsGenerator().setVisible(true);
            }
        });
    }
