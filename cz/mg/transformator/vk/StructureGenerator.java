...
public class StructureGenerator extends javax.swing.JFrame {
    ...
    */
    private void generateComplex(){
        ...
        output = output.replace("LABELS", genLabels(input));
    ...
    private String genLabels(String input){
        String[] lines = input.split("\\n");
        String labels = "";
        for(int i = 1; i < lines.length - 1; i++){
            String[] parts = lines[i].trim().split(" ");
            labels = labels + "            \"" + parts[parts.length-1].replace(";", "") + "\",\n";
        }
    ...
    private String genProperties(String input){
        ...
        String properties = "";
        for(int i = 1; i < lines.length - 1; i++){
            String[] parts = lines[i].trim().replace("const ", "").split(" ");
            String type = adaptPropertyType(parts[0]);
            String name = parts[parts.length-1];
            String property = type + " " + name;
            properties = properties + "    public " + property + "\n";
        }
        return properties.substring(0, properties.length()-1);
    }

    private String adaptPropertyType(String property){
        if(property.endsWith("*")) return "Pointer";
        return property;
    }
