...
public class VkPipelineRasterizationStateRasterizationOrderAMD extends VkObject {
    ...
    protected VkPipelineRasterizationStateRasterizationOrderAMD(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkPipelineRasterizationStateRasterizationOrderAMD(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkPipelineRasterizationStateRasterizationOrderAMD(VkPointer pointer) {
        super(pointer);
    }
    ...
    public void set(VkPipelineRasterizationStateRasterizationOrderAMD o){
    ...
    public static class Array extends VkPipelineRasterizationStateRasterizationOrderAMD implements cz.mg.collections.array.ReadonlyArray<VkPipelineRasterizationStateRasterizationOrderAMD> {
        ...
        public Array(VkPipelineRasterizationStateRasterizationOrderAMD o, int count){
