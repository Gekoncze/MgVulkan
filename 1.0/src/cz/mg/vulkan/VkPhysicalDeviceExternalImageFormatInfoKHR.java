...
public class VkPhysicalDeviceExternalImageFormatInfoKHR extends VkObject {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPhysicalDeviceExternalImageFormatInfoKHR.Pointer implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceExternalImageFormatInfoKHR.Pointer> {
            private final int count;
            ...
            public Array(VkPhysicalDeviceExternalImageFormatInfoKHR[] a) {
                this(a.length);
            ...
            @Override
            public VkPhysicalDeviceExternalImageFormatInfoKHR.Pointer get(int i){
                return new VkPhysicalDeviceExternalImageFormatInfoKHR.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
