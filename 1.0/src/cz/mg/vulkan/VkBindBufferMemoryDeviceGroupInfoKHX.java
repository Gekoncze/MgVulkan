...
public class VkBindBufferMemoryDeviceGroupInfoKHX extends VkObject {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkBindBufferMemoryDeviceGroupInfoKHX.Pointer implements cz.mg.collections.array.ReadonlyArray<VkBindBufferMemoryDeviceGroupInfoKHX.Pointer> {
            private final int count;
            ...
            public Array(VkBindBufferMemoryDeviceGroupInfoKHX[] a) {
                this(a.length);
            ...
            @Override
            public VkBindBufferMemoryDeviceGroupInfoKHX.Pointer get(int i){
                return new VkBindBufferMemoryDeviceGroupInfoKHX.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
