...
public class VkTessellationDomainOriginKHR extends VkEnum {
    ...
    public VkTessellationDomainOriginKHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    public VkTessellationDomainOriginKHR(VkMemory vkmemory, long vkaddress) {
    ...
    public static class Array extends VkTessellationDomainOriginKHR implements cz.mg.collections.array.ReadonlyArray<VkTessellationDomainOriginKHR> {
        ...
        public Array(int count, VkTessellationDomainOriginKHR o){
        ...
        public VkTessellationDomainOriginKHR get(int i){
            return new VkTessellationDomainOriginKHR(getVkMemory(), getVkAddress() + sizeof()*i);
        }
    }
}
