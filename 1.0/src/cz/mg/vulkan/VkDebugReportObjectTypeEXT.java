...
public class VkDebugReportObjectTypeEXT extends VkEnum {
    ...
    public VkDebugReportObjectTypeEXT(VkMemory vkmemory) {
        super(vkmemory);
    }

    public VkDebugReportObjectTypeEXT(VkMemory vkmemory, long vkaddress) {
    ...
    public String toString() {
        ...
        if(getValue() == VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT) return "VK_DEBUG_REPORT_OBJECT_TYPE_VALIDATION_CACHE_EXT";
    ...
    public static class Array extends VkDebugReportObjectTypeEXT implements cz.mg.collections.array.ReadonlyArray<VkDebugReportObjectTypeEXT> {
        ...
        public Array(int count, VkDebugReportObjectTypeEXT o){
        ...
        public VkDebugReportObjectTypeEXT get(int i){
            return new VkDebugReportObjectTypeEXT(getVkMemory(), addressAt(i));
        }
