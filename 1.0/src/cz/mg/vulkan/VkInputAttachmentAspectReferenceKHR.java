...
public class VkInputAttachmentAspectReferenceKHR extends VkObject {
    ...
    protected VkInputAttachmentAspectReferenceKHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkInputAttachmentAspectReferenceKHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkInputAttachmentAspectReferenceKHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkInputAttachmentAspectReferenceKHR implements cz.mg.collections.array.ReadonlyArray<VkInputAttachmentAspectReferenceKHR> {
        ...
        public Array(VkInputAttachmentAspectReferenceKHR o, int count){
