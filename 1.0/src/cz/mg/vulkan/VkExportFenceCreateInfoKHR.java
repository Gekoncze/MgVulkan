...
public class VkExportFenceCreateInfoKHR extends VkObject {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkExportFenceCreateInfoKHR.Pointer implements cz.mg.collections.array.ReadonlyArray<VkExportFenceCreateInfoKHR.Pointer> {
            private final int count;
            ...
            public Array(VkExportFenceCreateInfoKHR[] a) {
                this(a.length);
            ...
            @Override
            public VkExportFenceCreateInfoKHR.Pointer get(int i){
                return new VkExportFenceCreateInfoKHR.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
