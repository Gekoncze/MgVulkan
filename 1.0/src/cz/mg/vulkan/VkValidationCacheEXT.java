...
public class VkValidationCacheEXT extends VkNonDispatchableHandle {
    ...
    protected VkValidationCacheEXT(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkValidationCacheEXT(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkValidationCacheEXT(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkValidationCacheEXT implements cz.mg.collections.array.ReadonlyArray<VkValidationCacheEXT> {
        ...
        public Array(VkValidationCacheEXT o, int count){
        ...
        public Array(VkValidationCacheEXT... values){
            this(values.length);
        ...
        public VkValidationCacheEXT get(int i){
            return new VkValidationCacheEXT(getVkMemory(), address(i));
        }
