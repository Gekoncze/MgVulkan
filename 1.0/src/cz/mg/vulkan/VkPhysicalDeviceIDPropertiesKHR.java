...
public class VkPhysicalDeviceIDPropertiesKHR extends VkObject {
    ...
    public static class Array extends VkPhysicalDeviceIDPropertiesKHR implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceIDPropertiesKHR> {
        private final int count;

        public Array(int count) {
            super(new VkMemory(count*VkPhysicalDeviceIDPropertiesKHR.sizeof()));
            this.count = count;
        }
        ...
        @Override
        public VkPhysicalDeviceIDPropertiesKHR get(int i){
            return new VkPhysicalDeviceIDPropertiesKHR(getVkMemory(), getVkAddress() + sizeof()*i);
        }
    }
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkPhysicalDeviceIDPropertiesKHR.Pointer implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceIDPropertiesKHR.Pointer> {
            private final int count;
            ...
            public Array(VkPhysicalDeviceIDPropertiesKHR[] a) {
                this(a.length);
            ...
            @Override
            public VkPhysicalDeviceIDPropertiesKHR.Pointer get(int i){
                return new VkPhysicalDeviceIDPropertiesKHR.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
