...
public class VkSamplerYcbcrRangeKHR extends VkEnum {
    ...
    protected VkSamplerYcbcrRangeKHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkSamplerYcbcrRangeKHR(VkMemory vkmemory, long vkaddress) {
    ...
    public VkSamplerYcbcrRangeKHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkSamplerYcbcrRangeKHR implements cz.mg.collections.array.ReadonlyArray<VkSamplerYcbcrRangeKHR> {
        ...
        public Array(VkSamplerYcbcrRangeKHR o, int count){
        ...
        public VkSamplerYcbcrRangeKHR get(int i){
            return new VkSamplerYcbcrRangeKHR(getVkMemory(), address(i));
        }
