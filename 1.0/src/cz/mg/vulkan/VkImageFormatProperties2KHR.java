...
public class VkImageFormatProperties2KHR extends VkObject {
    ...
    protected VkImageFormatProperties2KHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkImageFormatProperties2KHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkImageFormatProperties2KHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkImageFormatProperties2KHR implements cz.mg.collections.array.ReadonlyArray<VkImageFormatProperties2KHR> {
        ...
        public Array(VkImageFormatProperties2KHR o, int count){
        ...
        public VkImageFormatProperties2KHR get(int i){
            return new VkImageFormatProperties2KHR(getVkMemory(), address(i));
        }
