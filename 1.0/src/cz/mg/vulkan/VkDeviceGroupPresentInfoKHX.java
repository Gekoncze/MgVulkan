...
public class VkDeviceGroupPresentInfoKHX extends VkObject {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkDeviceGroupPresentInfoKHX.Pointer implements cz.mg.collections.array.ReadonlyArray<VkDeviceGroupPresentInfoKHX.Pointer> {
            private final int count;
            ...
            public Array(VkDeviceGroupPresentInfoKHX[] a) {
                this(a.length);
            ...
            @Override
            public VkDeviceGroupPresentInfoKHX.Pointer get(int i){
                return new VkDeviceGroupPresentInfoKHX.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
