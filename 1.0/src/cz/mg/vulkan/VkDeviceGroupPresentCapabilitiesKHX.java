...
public class VkDeviceGroupPresentCapabilitiesKHX extends VkObject {
    ...
    protected VkDeviceGroupPresentCapabilitiesKHX(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkDeviceGroupPresentCapabilitiesKHX(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkDeviceGroupPresentCapabilitiesKHX(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkDeviceGroupPresentCapabilitiesKHX implements cz.mg.collections.array.ReadonlyArray<VkDeviceGroupPresentCapabilitiesKHX> {
        ...
        public Array(VkDeviceGroupPresentCapabilitiesKHX o, int count){
