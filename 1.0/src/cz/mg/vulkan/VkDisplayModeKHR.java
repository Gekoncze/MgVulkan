...
public class VkDisplayModeKHR extends VkNonDispatchableHandle {
    ...
    protected VkDisplayModeKHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkDisplayModeKHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkDisplayModeKHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkDisplayModeKHR implements cz.mg.collections.array.ReadonlyArray<VkDisplayModeKHR> {
        ...
        public Array(VkDisplayModeKHR o, int count){
        ...
        public Array(VkDisplayModeKHR... values){
            this(values.length);
        ...
        public VkDisplayModeKHR get(int i){
            return new VkDisplayModeKHR(getVkMemory(), address(i));
        }
