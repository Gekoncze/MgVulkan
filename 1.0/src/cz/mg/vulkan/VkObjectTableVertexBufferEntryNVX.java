...
public class VkObjectTableVertexBufferEntryNVX extends VkObject {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkObjectTableVertexBufferEntryNVX.Pointer implements cz.mg.collections.array.ReadonlyArray<VkObjectTableVertexBufferEntryNVX.Pointer> {
            private final int count;
            ...
            @Override
            public VkObjectTableVertexBufferEntryNVX.Pointer get(int i){
                return new VkObjectTableVertexBufferEntryNVX.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
