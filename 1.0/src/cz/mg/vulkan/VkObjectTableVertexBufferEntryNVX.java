...
public class VkObjectTableVertexBufferEntryNVX extends VkObject {
    ...
    protected VkObjectTableVertexBufferEntryNVX(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkObjectTableVertexBufferEntryNVX(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkObjectTableVertexBufferEntryNVX(VkPointer pointer) {
        super(pointer);
    }
    ...
    public void set(VkObjectTableVertexBufferEntryNVX o){
    ...
    public static class Array extends VkObjectTableVertexBufferEntryNVX implements cz.mg.collections.array.ReadonlyArray<VkObjectTableVertexBufferEntryNVX> {
        ...
        public Array(VkObjectTableVertexBufferEntryNVX o, int count){
