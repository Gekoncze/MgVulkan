...
public class VkDeviceGroupCommandBufferBeginInfoKHX extends VkObject {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkDeviceGroupCommandBufferBeginInfoKHX.Pointer implements cz.mg.collections.array.ReadonlyArray<VkDeviceGroupCommandBufferBeginInfoKHX.Pointer> {
            private final int count;
            ...
            public Array(VkDeviceGroupCommandBufferBeginInfoKHX[] a) {
                this(a.length);
            ...
            @Override
            public VkDeviceGroupCommandBufferBeginInfoKHX.Pointer get(int i){
                return new VkDeviceGroupCommandBufferBeginInfoKHX.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
