...
public class VkExternalImageFormatPropertiesKHR extends VkObject {
    ...
    public static class Array extends VkExternalImageFormatPropertiesKHR implements cz.mg.collections.array.ReadonlyArray<VkExternalImageFormatPropertiesKHR> {
        ...
        public VkExternalImageFormatPropertiesKHR get(int i){
            return new VkExternalImageFormatPropertiesKHR(getVkMemory(), getVkAddress() + sizeof()*i);
        }
    }
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkExternalImageFormatPropertiesKHR.Pointer implements cz.mg.collections.array.ReadonlyArray<VkExternalImageFormatPropertiesKHR.Pointer> {
            private final int count;
            ...
            public Array(VkExternalImageFormatPropertiesKHR[] a) {
                this(a.length);
            ...
            @Override
            public VkExternalImageFormatPropertiesKHR.Pointer get(int i){
                return new VkExternalImageFormatPropertiesKHR.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
