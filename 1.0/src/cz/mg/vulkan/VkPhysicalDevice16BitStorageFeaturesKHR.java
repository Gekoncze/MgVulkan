...
public class VkPhysicalDevice16BitStorageFeaturesKHR extends VkObject {
    ...
    protected VkPhysicalDevice16BitStorageFeaturesKHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkPhysicalDevice16BitStorageFeaturesKHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkPhysicalDevice16BitStorageFeaturesKHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkPhysicalDevice16BitStorageFeaturesKHR implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDevice16BitStorageFeaturesKHR> {
        ...
        public Array(VkPhysicalDevice16BitStorageFeaturesKHR o, int count){
        ...
        public VkPhysicalDevice16BitStorageFeaturesKHR get(int i){
            return new VkPhysicalDevice16BitStorageFeaturesKHR(getVkMemory(), address(i));
        }
