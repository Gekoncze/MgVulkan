...
public class VkBufferMemoryRequirementsInfo2KHR extends VkObject {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkBufferMemoryRequirementsInfo2KHR.Pointer implements cz.mg.collections.array.ReadonlyArray<VkBufferMemoryRequirementsInfo2KHR.Pointer> {
            private final int count;
            ...
            public Array(VkBufferMemoryRequirementsInfo2KHR[] a) {
                this(a.length);
            ...
            @Override
            public VkBufferMemoryRequirementsInfo2KHR.Pointer get(int i){
                return new VkBufferMemoryRequirementsInfo2KHR.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
