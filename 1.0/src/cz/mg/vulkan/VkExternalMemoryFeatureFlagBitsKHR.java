...
public class VkExternalMemoryFeatureFlagBitsKHR extends VkFlagBits {
    ...
    protected VkExternalMemoryFeatureFlagBitsKHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkExternalMemoryFeatureFlagBitsKHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkExternalMemoryFeatureFlagBitsKHR(VkPointer pointer) {
        super(pointer);
    }
