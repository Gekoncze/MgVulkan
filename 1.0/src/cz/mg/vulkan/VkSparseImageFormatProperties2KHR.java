...
public class VkSparseImageFormatProperties2KHR extends VkObject {
    ...
    protected VkSparseImageFormatProperties2KHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkSparseImageFormatProperties2KHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkSparseImageFormatProperties2KHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkSparseImageFormatProperties2KHR implements cz.mg.collections.array.ReadonlyArray<VkSparseImageFormatProperties2KHR> {
        ...
        public Array(VkSparseImageFormatProperties2KHR o, int count){
        ...
        public VkSparseImageFormatProperties2KHR get(int i){
            return new VkSparseImageFormatProperties2KHR(getVkMemory(), address(i));
        }
