...
public class VkPipelineCreateFlagBits extends VkFlagBits {
    ...
    public static final int VK_PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHX = 0x00000008;
    public static final int VK_PIPELINE_CREATE_DISPATCH_BASE_KHX = 0x00000010;
    ...
    public String toString() {
        ...
        if((getValue() & VK_PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHX) != 0) s.addLast("VK_PIPELINE_CREATE_VIEW_INDEX_FROM_DEVICE_INDEX_BIT_KHX");
        if((getValue() & VK_PIPELINE_CREATE_DISPATCH_BASE_KHX) != 0) s.addLast("VK_PIPELINE_CREATE_DISPATCH_BASE_KHX");
