...
public class VkMemoryRequirements2KHR extends VkObject {
    ...
    protected VkMemoryRequirements2KHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkMemoryRequirements2KHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkMemoryRequirements2KHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkMemoryRequirements2KHR implements cz.mg.collections.array.ReadonlyArray<VkMemoryRequirements2KHR> {
        ...
        public Array(VkMemoryRequirements2KHR o, int count){
        ...
        public VkMemoryRequirements2KHR get(int i){
            return new VkMemoryRequirements2KHR(getVkMemory(), address(i));
        }
