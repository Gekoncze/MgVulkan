...
public class VkExternalMemoryPropertiesKHR extends VkObject {
    ...
    public static class Array extends VkExternalMemoryPropertiesKHR implements cz.mg.collections.array.ReadonlyArray<VkExternalMemoryPropertiesKHR> {
        ...
        public VkExternalMemoryPropertiesKHR get(int i){
            return new VkExternalMemoryPropertiesKHR(getVkMemory(), getVkAddress() + sizeof()*i);
        }
    }
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkExternalMemoryPropertiesKHR.Pointer implements cz.mg.collections.array.ReadonlyArray<VkExternalMemoryPropertiesKHR.Pointer> {
            private final int count;
            ...
            public Array(VkExternalMemoryPropertiesKHR[] a) {
                this(a.length);
            ...
            @Override
            public VkExternalMemoryPropertiesKHR.Pointer get(int i){
                return new VkExternalMemoryPropertiesKHR.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
        }
    }
}
