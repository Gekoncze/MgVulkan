...
public class VkPhysicalDeviceMemoryProperties2KHR extends VkObject {
    ...
    protected VkPhysicalDeviceMemoryProperties2KHR(VkMemory vkmemory) {
        super(vkmemory);
    }

    protected VkPhysicalDeviceMemoryProperties2KHR(VkMemory vkmemory, long vkaddress) {
        super(vkmemory, vkaddress);
    }

    public VkPhysicalDeviceMemoryProperties2KHR(VkPointer pointer) {
        super(pointer);
    }
    ...
    public static class Array extends VkPhysicalDeviceMemoryProperties2KHR implements cz.mg.collections.array.ReadonlyArray<VkPhysicalDeviceMemoryProperties2KHR> {
        ...
        public Array(VkPhysicalDeviceMemoryProperties2KHR o, int count){
        ...
        public VkPhysicalDeviceMemoryProperties2KHR get(int i){
            return new VkPhysicalDeviceMemoryProperties2KHR(getVkMemory(), address(i));
        }
