...
public class VkAcquireNextImageInfoKHX extends VkObject {
    ...
    public static class Pointer extends VkObject.Pointer {
        ...
        public static class Array extends VkAcquireNextImageInfoKHX.Pointer implements cz.mg.collections.array.ReadonlyArray<VkAcquireNextImageInfoKHX.Pointer> {
            private final int count;
            ...
            public Array(VkAcquireNextImageInfoKHX[] a) {
                this(a.length);
            ...
            @Override
            public VkAcquireNextImageInfoKHX.Pointer get(int i){
                return new VkAcquireNextImageInfoKHX.Pointer(getVkMemory(), getVkAddress() + VkPointer.sizeof()*i);
            }
