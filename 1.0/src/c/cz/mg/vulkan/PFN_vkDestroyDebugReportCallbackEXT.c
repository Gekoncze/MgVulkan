...
void Java_cz_mg_vulkan_PFNvkDestroyDebugReportCallbackEXT_callNative(JNIEnv* env, jclass jc, jlong address, jlong instance, jlong callback, jlong pAllocator){
    (void)env;
    (void)jc;
