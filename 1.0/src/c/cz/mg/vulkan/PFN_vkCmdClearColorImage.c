...
void Java_cz_mg_vulkan_PFNvkCmdClearColorImage_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong image, jlong imageLayout, jlong pColor, jlong rangeCount, jlong pRanges){
    (void)env;
    (void)jc;
