...
void Java_cz_mg_vulkan_PFNvkGetImageSparseMemoryRequirements_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong image, jlong pSparseMemoryRequirementCount, jlong pSparseMemoryRequirements){
    (void)env;
    (void)jc;
