...
jint Java_cz_mg_vulkan_PFNvkCreateShaderModule_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pShaderModule){
    (void)env;
    (void)jc;
