...
jint Java_cz_mg_vulkan_PFNvkCreateDescriptorSetLayout_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pSetLayout){
    (void)env;
    (void)jc;
