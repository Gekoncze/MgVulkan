...
jint Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceSurfaceCapabilitiesKHR_callNative(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong surface, jlong pSurfaceCapabilities){
    (void)env;
    (void)jc;
