...
void Java_cz_mg_vulkan_PFNvkCmdExecuteCommands_call(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong commandBufferCount, jlong pCommandBuffers){
    (void)env;
    (void)jc;
