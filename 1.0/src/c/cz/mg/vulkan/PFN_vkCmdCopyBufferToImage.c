...
void Java_cz_mg_vulkan_PFNvkCmdCopyBufferToImage_callNative(JNIEnv* env, jclass jc, jlong address, jlong commandBuffer, jlong srcBuffer, jlong dstImage, jint dstImageLayout, jint regionCount, jlong pRegions){
    (void)env;
    (void)jc;
