...
void Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceGeneratedCommandsPropertiesNVX_callNative(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong pFeatures, jlong pLimits){
    (void)env;
    (void)jc;
