...
void Java_cz_mg_vulkan_PFNvkDestroyDescriptorSetLayout_call(JNIEnv* env, jclass jc, jlong address, jlong device, jlong descriptorSetLayout, jlong pAllocator){
    (void)env;
    (void)jc;
