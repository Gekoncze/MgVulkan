...
void Java_cz_mg_vulkan_PFNvkGetBufferMemoryRequirements2_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pInfo, jlong pMemoryRequirements){
    (void)env;
    (void)jc;
