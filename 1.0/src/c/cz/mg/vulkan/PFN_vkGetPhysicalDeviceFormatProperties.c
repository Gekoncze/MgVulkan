...
void Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceFormatProperties_callNative(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jint format, jlong pFormatProperties){
    (void)env;
    (void)jc;
