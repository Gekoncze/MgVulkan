...
void Java_cz_mg_vulkan_PFNvkEnumerateInstanceLayerProperties_call(JNIEnv* env, jclass jc, jlong address, jlong pPropertyCount, jlong pProperties, jlong rval){
    (void)env;
    (void)jc;
