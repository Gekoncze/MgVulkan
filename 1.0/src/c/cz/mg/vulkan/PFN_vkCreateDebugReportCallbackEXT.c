...
jint Java_cz_mg_vulkan_PFNvkCreateDebugReportCallbackEXT_callNative(JNIEnv* env, jclass jc, jlong address, jlong instance, jlong pCreateInfo, jlong pAllocator, jlong pCallback){
    (void)env;
    (void)jc;
