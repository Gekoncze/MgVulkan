...
jint Java_cz_mg_vulkan_PFNvkEnumeratePhysicalDeviceGroups_callNative(JNIEnv* env, jclass jc, jlong address, jlong instance, jlong pPhysicalDeviceGroupCount, jlong pPhysicalDeviceGroupProperties){
    (void)env;
    (void)jc;
