...
void Java_cz_mg_vulkan_PFNvkGetDisplayPlaneCapabilitiesKHR_call(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong mode, jlong planeIndex, jlong pCapabilities, jlong rval){
    (void)env;
    (void)jc;
