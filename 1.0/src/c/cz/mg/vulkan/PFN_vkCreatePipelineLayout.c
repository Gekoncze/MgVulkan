...
jint Java_cz_mg_vulkan_PFNvkCreatePipelineLayout_callNative(JNIEnv* env, jclass jc, jlong address, jlong device, jlong pCreateInfo, jlong pAllocator, jlong pPipelineLayout){
    (void)env;
    (void)jc;
