...
jlong Java_cz_mg_vulkan_VkMemoryDedicatedRequirementsKHR_sizeof(JNIEnv* env, jclass jc)
{
    (void)env;
    (void)jc;
...
jlong Java_cz_mg_vulkan_VkMemoryDedicatedRequirementsKHR_getSType(JNIEnv* env, jclass jc, jlong address)
{
    (void)env;
    (void)jc;
    VkMemoryDedicatedRequirementsKHR* o = (VkMemoryDedicatedRequirementsKHR*)jniLongToPointer(address);
