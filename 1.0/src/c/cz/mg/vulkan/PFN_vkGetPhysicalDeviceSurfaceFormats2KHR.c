...
jint Java_cz_mg_vulkan_PFNvkGetPhysicalDeviceSurfaceFormats2KHR_callNative(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong pSurfaceInfo, jlong pSurfaceFormatCount, jlong pSurfaceFormats){
    (void)env;
    (void)jc;
