...
jint Java_cz_mg_vulkan_PFNvkCreateDisplayModeKHR_callNative(JNIEnv* env, jclass jc, jlong address, jlong physicalDevice, jlong display, jlong pCreateInfo, jlong pAllocator, jlong pMode){
    (void)env;
    (void)jc;
